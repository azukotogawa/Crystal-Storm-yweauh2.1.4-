...
func _run() -> void:
	...
	data.patch_local_column(0, 0, data.get_surface_y(0, 0), _VoxelTypes.GRASSLAND3)
	data.patch_local_column(7, 7, data.get_surface_y(7, 7), _VoxelTypes.MOUNTAIN2)
	data.patch_local_column(15, 15, data.get_surface_y(15, 15), _VoxelTypes.SNOW)
