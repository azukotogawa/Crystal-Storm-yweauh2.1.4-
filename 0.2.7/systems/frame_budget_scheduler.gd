...
const SYS_WORLD_BAKE_FILL := &"world_bake_fill"
...
const DEFAULT_BUDGET_US := {
	...
	## Schedule/collect only — generation runs on WorkerThreadPool.
	SYS_WORLD_BAKE_FILL: 2500,
	SYS_HUD: 800,
}
