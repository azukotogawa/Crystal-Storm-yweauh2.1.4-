...
@export var color_ocean: Color = Color(0.18, 0.38, 0.72)
@export var color_mountain: Color = Color(0.42, 0.40, 0.44)
@export var color_water: Color = Color(0.22, 0.48, 0.82)
@export var color_channel: Color = Color(0.18, 0.62, 0.92)
@export var color_crystal: Color = Color(0.62, 0.18, 0.95, 0.85)
